...
2. Now, a static site generator needs to be installed. To do, open command prompt and type _gem installer bundler jekyll_, and let it finish installing.
...
3. Now, download Git desktop and login using your GitHub account. Once you are logged in, perform following tasks:
    ...
    - Once it has been cloned, go to the path where you cloned your repostitory, Copy and paste the _Readme.md_ file and your _Resume.md_ to this directory.
...
-  Open command prompt and go to the directory where you cloned your repository.
- Type jekyll new _Name-of-your-site_, and hit enter.
- Type cd _Name-of-your-site_ and hit enter. Then type bundle exec jekyll serve
