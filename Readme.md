...
2. Now, a static site generator needs to be installed. To do that perform following tasks. 

    - Open command prompt and type _gem installer bundler jekyll_, and let it finish installing.
    - Once it get installed. Your new website can be created using the command _"jekyll new your-websites-name"_.
